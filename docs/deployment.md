...
Для проверки гипотезы Blueprint использует бесплатный instance. После простоя он может засыпать;
при подтверждении гипотезы смените план на постоянно работающий Starter.
